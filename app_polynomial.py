...
DEFAULT_PATH = BASE_DIR / "sustainability_data.csv"
...
if uploaded_file is not None:
    ...
    try:
        ...
        st.sidebar.info(f"Using bundled dataset at {DEFAULT_PATH}.")
...
with tab_eda:
    ...
    x_vals = data[feat_choice].to_numpy()
    y_vals = data[TARGET].to_numpy()
